...
use App\Entity\OfferConversations;
 ...
 */
class OfferConversationsRepository extends ServiceEntityRepository
{
    public function __construct(ManagerRegistry $registry)
    {
        parent::__construct($registry, OfferConversations::class);
    }

    public function add(OfferConversations $entity, bool $flush = false): void
    {
    ...
    public function remove(OfferConversations $entity, bool $flush = false): void
    {
